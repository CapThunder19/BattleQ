...
export interface BTQTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BTQToken extends BaseContract {
  connect(runner?: ContractRunner | null): BTQToken;
  waitForDeployment(): Promise<this>;

  interface: BTQTokenInterface;

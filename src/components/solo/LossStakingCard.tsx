        ...
        >
            ...
            >
                ...
                <div className="bg-red-950/20 border border-red-600/30 p-8 relative group overflow-hidden mb-10">
                    ...
                    <span className="text-[10px] text-red-500 font-bold uppercase tracking-[0.3em] mb-3 block opacity-70">INIT_TRANSFERRED_OUT</span>
                    <div className="flex items-baseline gap-4">
                        ...
                        <span className="text-xs font-black text-red-500 tracking-[0.4em] uppercase">INIT</span>
                    </div>
                </div>
